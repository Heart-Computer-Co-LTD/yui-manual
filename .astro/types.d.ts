...
"2023-12-27-倉庫の設定（その１）.mdx": {
  id: "2023-12-27-倉庫の設定（その１）.mdx",
  slug: "2023-12-27-倉庫の設定その１",
  body: string,
  collection: "blog",
  data: InferEntrySchema<"blog">
} & { render(): Render[".mdx"] },
...
"page-7-reportsample.mdx": {
  id: "page-7-reportsample.mdx",
  slug: "page-7-reportsample",
  body: string,
  collection: "doc",
  data: InferEntrySchema<"doc">
} & { render(): Render[".mdx"] },
"page-payment-01.md": {
  id: "page-payment-01.md",
  slug: "page-payment-01",
  body: string,
  collection: "doc",
  data: InferEntrySchema<"doc">
} & { render(): Render[".md"] },
